$(document).on('click', '#createcampaign', function () {
    ...
    if (name == '' || name == null) {
        ...
        dialog = bootbox.dialog({
          ...
          '<div class="row"> <div class="name-popup-detail"> <span class="no-name-error"> oops! </span> <br>  your list doesn&#39;t have a name yet <br> Pls name it and you will be one step closer!    </div>' +
        ...
        success: function (jqXHR, textStatus, errorThrown) {
            ...
            if (jqXHR != 0 || jqXHR != '0') {
                dialog = bootbox.dialog({
                    ...
                    '<div class="row"> <div class="successful-list-detail success">   <span class="yay"> YAY! </span> <br/> '+ name +' List created sucessfully  </div>' +
